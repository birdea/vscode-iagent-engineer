...
const FORMAT_INSTRUCTIONS: Record<OutputFormat, string> = {
  ...
  kotlin:
    'Generate Jetpack Compose UI code in Kotlin. Use Material3 components. Do not emit HTML, TSX, JSX, React, XML, or SwiftUI.',
};
...
const FORMAT_FORBIDDEN: Record<OutputFormat, string> = {
  ...
  kotlin: 'Forbidden: HTML, TSX, JSX, React, XML layout files, markdown fences, explanations.',
};
