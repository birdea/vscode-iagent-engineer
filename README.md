...
- Browser preview now works in packaged macOS installs.
- Preview actions report browser-to-panel fallback status more clearly.
- Preview panel runtime resolution is stricter and safer for workspace imports.
